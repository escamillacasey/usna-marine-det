...
HEADER='<!-- CASCADE paste → intranet company mentors (e.g. mardet/company-mentors.php) -->
...
<div class="container">
<h1 class="page-header__title">Marine Company Mentors</h1>
<p class="page-header__subtitle">One Marine officer dedicated to each of the Brigade'\''s 36 companies.</p>
</div>
</header>
...
<p>Not sure how mentors fit among other Marines on the Yard? See <a href="marines-on-the-yard.php">Marines on the Yard</a> for the full picture.</p>
