...
Publish these to **USNA intranet** (`intranet.usna.edu/USMC/`). **Do not** deploy to the public `www.usna.edu` site or GitHub Pages.
...
**Static Cascade paste (no JS):** after sync, run `bash scripts/build-intranet-mentors-paste.sh` and re-paste `cascade/paste-intranet-company-mentors-marinecorps.html` into **`company_mentors.php`** on **intranet.usna.edu/USMC/**.
